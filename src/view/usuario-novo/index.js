...
function NovoUsuario(){
    ...
    function cadastrar(){
        ...
        firebaseConfig.auth().createUserWithEmailAndPassword(email,senha).then(resultado => {
            setCarregando(0);
            setMsgTipo('sucesso')
        }).catch (erro => {
            setCarregando(0);
        ...
        <>
            ...
            <div className="form-cadastro">
                <form className="text-center form-login mx-auto mt-5">
                    ...
                    <input type='email' onChange={(e) => setEmail(e.target.value)}  className='form-control my-2' placeholder="Email"/>
                    <input type='assword' onChange={(e) => setSenha(e.target.value)}  className='form-control my-2' placeholder="Senha"/>
